        ...
        <div class="row">
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Water Level & Rainfall</h3>
            ...
            <!-- /.card -->
             ...
             <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Electrical Conductivity</h3>
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">River Parameters</h3>
          ...
          <div class="col-md-6">
            ...
            <div class="card card-info">
              <div class="card-header">
                <h3 class="card-title">Turbidity & Ph</h3>
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Temperature & Rainfall</h3>
